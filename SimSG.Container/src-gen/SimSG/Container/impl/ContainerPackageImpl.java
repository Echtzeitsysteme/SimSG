...
public class ContainerPackageImpl extends EPackageImpl implements ContainerPackage {
	 ...
	 * @see SimSG.Container.ContainerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(containerEClass, SimSG.Container.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Agents(), this.getAgent(), null, "agents", null, 0, -1,
				SimSG.Container.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContainer_ModelName(), theXMLTypePackage.getString(), "ModelName", null, 0, 1,
				SimSG.Container.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
