...
public class InternalReactionRulesLexer extends Lexer {
    ...
    public final void mRULE_AT() throws RecognitionException {
        try {
            int _type = RULE_AT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6560:9: ( '@' )
            // InternalReactionRules.g:6560:11: '@'
            {
            match('@'); 
    ...
    public final void mRULE_BI() throws RecognitionException {
        try {
            int _type = RULE_BI;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6562:9: ( '<->' )
            // InternalReactionRules.g:6562:11: '<->'
            {
            match("<->"); 
    ...
    public final void mRULE_UNI() throws RecognitionException {
        try {
            int _type = RULE_UNI;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6564:10: ( '->' )
            // InternalReactionRules.g:6564:12: '->'
            {
            match("->"); 
    ...
    public final void mRULE_SEMI_LINK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6566:16: ( 'semi' )
            // InternalReactionRules.g:6566:18: 'semi'
            {
            match("semi"); 
    ...
    public final void mRULE_FREE_LINK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6568:16: ( 'free' )
            // InternalReactionRules.g:6568:18: 'free'
            {
            match("free"); 
    ...
    public final void mRULE_WHATEVER_LINK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6570:20: ( '?' )
            // InternalReactionRules.g:6570:22: '?'
            {
            match('?'); 
    ...
    public final void mRULE_EXPONENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6572:15: ( 'E' )
            // InternalReactionRules.g:6572:17: 'E'
            {
            match('E'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6574:10: ( '0' .. '9' ( '0' .. '9' )* )
            // InternalReactionRules.g:6574:12: '0' .. '9' ( '0' .. '9' )*
            {
            matchRange('0','9'); 
            // InternalReactionRules.g:6574:21: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalReactionRules.g:6574:22: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6576:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalReactionRules.g:6576:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalReactionRules.g:6576:11: ( '^' )?
            int alt2=2;
            ...
            // InternalReactionRules.g:6576:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6578:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalReactionRules.g:6578:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalReactionRules.g:6578:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalReactionRules.g:6578:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalReactionRules.g:6578:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalReactionRules.g:6578:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalReactionRules.g:6578:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalReactionRules.g:6578:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalReactionRules.g:6578:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalReactionRules.g:6578:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalReactionRules.g:6578:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6580:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalReactionRules.g:6580:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalReactionRules.g:6580:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalReactionRules.g:6580:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6582:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalReactionRules.g:6582:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalReactionRules.g:6582:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // InternalReactionRules.g:6582:40: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalReactionRules.g:6582:41: ( '\\r' )? '\\n'
                    {
                    // InternalReactionRules.g:6582:41: ( '\\r' )?
                    int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6584:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalReactionRules.g:6584:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalReactionRules.g:6584:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReactionRules.g:6586:16: ( . )
            // InternalReactionRules.g:6586:18: .
            {
            matchAny(); 
    ...
    static final String DFA12_eotS =
        "\1\uffff\1\44\1\uffff\4\47\6\uffff\2\47\3\uffff\3\47\1\uffff\1\42\2\47\1\uffff\1\76\1\uffff\1\42\1\uffff\3\42\5\uffff\1\47\1\uffff\3\47\6\uffff\2\47\3\uffff\3\47\2\uffff\2\47\7\uffff\1\117\4\47\1\124\1\125\4\47\1\uffff\1\132\3\47\2\uffff\1\136\1\137\1\140\1\141\1\uffff\2\47\1\144\4\uffff\2\47\1\uffff\1\147\1\47\1\uffff\5\47\1\156\1\uffff";
    static final String DFA12_eofS =
        "\157\uffff";
    static final String DFA12_minS =
        "\1\0\1\76\1\uffff\1\122\1\101\1\157\1\147\6\uffff\1\147\1\141\3\uffff\1\142\1\156\1\165\1\uffff\1\55\1\145\1\162\1\uffff\1\60\1\uffff\1\101\1\uffff\2\0\1\52\5\uffff\1\111\1\uffff\1\124\1\144\1\145\6\uffff\1\145\1\162\3\uffff\1\163\1\151\1\154\2\uffff\1\155\1\145\7\uffff\1\60\1\110\1\145\2\156\2\60\1\164\1\145\1\151\1\145\1\uffff\1\60\1\154\2\164\2\uffff\4\60\1\uffff\2\111\1\60\4\uffff\1\104\1\156\1\uffff\1\60\1\163\1\uffff\1\164\1\141\1\156\1\143\1\145\1\60\1\uffff";
    static final String DFA12_maxS =
        "\1\uffff\1\76\1\uffff\1\122\1\101\1\157\1\147\6\uffff\1\147\1\141\3\uffff\1\142\1\156\1\165\1\uffff\1\55\1\145\1\162\1\uffff\1\172\1\uffff\1\172\1\uffff\2\uffff\1\57\5\uffff\1\111\1\uffff\1\124\1\144\1\145\6\uffff\1\145\1\162\3\uffff\1\163\1\151\1\154\2\uffff\1\155\1\145\7\uffff\1\172\1\110\1\145\2\156\2\172\1\164\1\145\1\151\1\145\1\uffff\1\172\1\154\2\164\2\uffff\4\172\1\uffff\2\111\1\172\4\uffff\1\104\1\156\1\uffff\1\172\1\163\1\uffff\1\164\1\141\1\156\1\143\1\145\1\172\1\uffff";
    static final String DFA12_acceptS =
        "\2\uffff\1\2\4\uffff\1\7\1\10\1\11\1\12\1\13\1\14\2\uffff\1\17\1\20\1\21\3\uffff\1\25\3\uffff\1\32\1\uffff\1\34\1\uffff\1\35\3\uffff\1\41\1\42\1\27\1\1\1\2\1\uffff\1\35\3\uffff\1\7\1\10\1\11\1\12\1\13\1\14\2\uffff\1\17\1\20\1\21\3\uffff\1\25\1\26\2\uffff\1\32\1\33\1\34\1\36\1\37\1\40\1\41\13\uffff\1\3\4\uffff\1\16\1\22\4\uffff\1\4\3\uffff\1\23\1\24\1\30\1\31\2\uffff\1\15\2\uffff\1\5\6\uffff\1\6";
