 ...
 * </p>
 * <ul>
 *   <li>{@link biochemsimulation.reactionrules.reactionRules.impl.StatesImpl#getState <em>State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatesImpl extends MinimalEObjectImpl.Container implements States
{
  ...
  {
    return ReactionRulesPackage.Literals.STATES;
  }
  ...
  public EList<State> getState()
  {
    if (state == null)
    {
      state = new EObjectContainmentEList<State>(State.class, this, ReactionRulesPackage.STATES__STATE);
    }
    return state;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReactionRulesPackage.STATES__STATE:
