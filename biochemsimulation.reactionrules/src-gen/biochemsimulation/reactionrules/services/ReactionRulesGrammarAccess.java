...
public class ReactionRulesGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class SingleSiteElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.SingleSite");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MultiSiteElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.MultiSite");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BoundAnyLinkElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.BoundAnyLink");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BoundLinkElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.BoundLink");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MultiLinkElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.MultiLink");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cStatesFreeLinkParserRuleCall_1_0_0_1 = (RuleCall)cStatesAlternatives_1_0_0.eContents().get(1);
		...
		private final RuleCall cStatesFreeLinkParserRuleCall_1_1_1_0_1 = (RuleCall)cStatesAlternatives_1_1_1_0.eContents().get(1);
		
		//MultiLink LinkState:
		//	{MultiLink} (states+=(BoundLink | FreeLink) (',' states+=(BoundLink | FreeLink))+)?;
		@Override public ParserRule getRule() { return rule; }
		...
		//(states+=(BoundLink | FreeLink) (',' states+=(BoundLink | FreeLink))+)?
		public Group getGroup_1() { return cGroup_1; }
		
		//states+=(BoundLink | FreeLink)
		...
		//FreeLink
		public RuleCall getStatesFreeLinkParserRuleCall_1_0_0_1() { return cStatesFreeLinkParserRuleCall_1_0_0_1; }
		...
		//FreeLink
		public RuleCall getStatesFreeLinkParserRuleCall_1_1_1_0_1() { return cStatesFreeLinkParserRuleCall_1_1_1_0_1; }
	}
	...
	public class BoundAnyOfTypeLinkSiteElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.BoundAnyOfTypeLinkSite");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BoundAnyOfTypeLinkElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.BoundAnyOfTypeLink");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LinkStateElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cLinkStateBoundAnyOfTypeLinkParserRuleCall_2_0_2 = (RuleCall)cLinkStateAlternatives_2_0.eContents().get(2);
		private final RuleCall cLinkStateBoundLinkParserRuleCall_2_0_3 = (RuleCall)cLinkStateAlternatives_2_0.eContents().get(3);
		...
		//{LinkState} '[' linkState=(BoundAnyLink | FreeLink | BoundAnyOfTypeLink | BoundLink | WhatEver) ']'
		public Group getGroup() { return cGroup; }
		...
		//(BoundAnyLink | FreeLink | BoundAnyOfTypeLink | BoundLink | WhatEver)
		...
		//BoundAnyOfTypeLink
		public RuleCall getLinkStateBoundAnyOfTypeLinkParserRuleCall_2_0_2() { return cLinkStateBoundAnyOfTypeLinkParserRuleCall_2_0_2; }
		
		//BoundLink
		public RuleCall getLinkStateBoundLinkParserRuleCall_2_0_3() { return cLinkStateBoundLinkParserRuleCall_2_0_3; }
	...
	public class MultiLinkStateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.MultiLinkState");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cLinkStateFreeLinkParserRuleCall_2_0_1 = (RuleCall)cLinkStateAlternatives_2_0.eContents().get(1);
		private final RuleCall cLinkStateBoundAnyLinkParserRuleCall_2_0_2 = (RuleCall)cLinkStateAlternatives_2_0.eContents().get(2);
		private final RuleCall cLinkStateBoundLinkParserRuleCall_2_0_3 = (RuleCall)cLinkStateAlternatives_2_0.eContents().get(3);
		private final RuleCall cLinkStateMultiLinkParserRuleCall_2_0_4 = (RuleCall)cLinkStateAlternatives_2_0.eContents().get(4);
		private final Keyword cRightSquareBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		
		//MultiLinkState:
		//	{MultiLinkState}
		//	'*[' linkState=(WhatEver | FreeLink | BoundAnyLink | BoundLink | MultiLink) ']';
		@Override public ParserRule getRule() { return rule; }
		
		//{MultiLinkState} '*[' linkState=(WhatEver | FreeLink | BoundAnyLink | BoundLink | MultiLink) ']'
		public Group getGroup() { return cGroup; }
		...
		//(WhatEver | FreeLink | BoundAnyLink | BoundLink | MultiLink)
		public Alternatives getLinkStateAlternatives_2_0() { return cLinkStateAlternatives_2_0; }
		...
		//BoundAnyLink
		public RuleCall getLinkStateBoundAnyLinkParserRuleCall_2_0_2() { return cLinkStateBoundAnyLinkParserRuleCall_2_0_2; }
		
		//BoundLink
		public RuleCall getLinkStateBoundLinkParserRuleCall_2_0_3() { return cLinkStateBoundLinkParserRuleCall_2_0_3; }
		
		//MultiLink
		public RuleCall getLinkStateMultiLinkParserRuleCall_2_0_4() { return cLinkStateMultiLinkParserRuleCall_2_0_4; }
		
		//']'
		public Keyword getRightSquareBracketKeyword_3() { return cRightSquareBracketKeyword_3; }
	}
	public class SingleSitePatternElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.SingleSitePattern");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MultiLinkSitePatternElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.MultiLinkSitePattern");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public ReactionRulesGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tBOUND_LINK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "biochemsimulation.reactionrules.ReactionRules.BOUND_LINK");
