...
public class TestR1Matcher extends BaseMatcher<TestR1Match> {
   ...
   * 
   */
  public Collection<TestR1Match> getAllMatches(final AgentInstance pA, final AgentInstance pB) {
   ...
   * 
   */
  public TestR1Match getOneArbitraryMatch(final AgentInstance pA, final AgentInstance pB) {
   ...
   * 
   */
  public void forEachMatch(final AgentInstance pA, final AgentInstance pB, final IMatchProcessor<? super TestR1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final AgentInstance pA, final AgentInstance pB, final IMatchProcessor<? super TestR1Match> processor) {
   ...
   * 
   */
  public TestR1Match newMatch(final AgentInstance pA, final AgentInstance pB) {
    return TestR1Match.newMatch(pA, pB);
  }
   ...
   * 
   */
  public Set<AgentInstance> getAllValuesOfb(final TestR1Match partialMatch) {
  ...
  protected TestR1Match tupleToMatch(final Tuple t) {
    try {
        return TestR1Match.newMatch((AgentInstance) t.get(POSITION_A), (AgentInstance) t.get(POSITION_B));
  ...
  protected TestR1Match arrayToMatch(final Object[] match) {
    try {
        return TestR1Match.newMatch((AgentInstance) match[POSITION_A], (AgentInstance) match[POSITION_B]);
    } catch(ClassCastException e) {
  ...
  protected TestR1Match arrayToMatchMutable(final Object[] match) {
    try {
        return TestR1Match.newMutableMatch((AgentInstance) match[POSITION_A], (AgentInstance) match[POSITION_B]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
