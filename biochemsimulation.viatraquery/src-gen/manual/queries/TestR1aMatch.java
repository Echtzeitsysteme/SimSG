...
public abstract class TestR1aMatch extends BasePatternMatch {
  ...
  private TestR1aMatch(final AgentInstance pA, final String pAgentName, final String pSiteName) {
    this.fA = pA;
   ...
   * 
   */
  public static TestR1aMatch newMutableMatch(final AgentInstance pA, final String pAgentName, final String pSiteName) {
   ...
   * 
   */
  public static TestR1aMatch newMatch(final AgentInstance pA, final String pAgentName, final String pSiteName) {
