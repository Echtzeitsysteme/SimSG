...
/**
 * Generated pattern matcher API of the manual.queries.testR2a pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link TestR2aMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see TestR2aQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class TestR2aMatcher extends BaseMatcher<TestR2aMatch> {
  /**
   ...
   * 
   */
  public static TestR2aMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    TestR2aMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
        matcher = (TestR2aMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static TestR2aMatcher create() throws ViatraQueryException {
    return new TestR2aMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TestR2aMatcher.class);
   ...
   * 
   */
  private TestR2aMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a TestR2aMatch object.
   * 
   */
  public Collection<TestR2aMatch> getAllMatches(final AgentInstance pA, final String pAgentName, final String pSiteName) {
   ...
   * @param pAgentName the fixed value of pattern parameter agentName, or null if not bound.
   * @param pSiteName the fixed value of pattern parameter siteName, or null if not bound.
   * @return a match represented as a TestR2aMatch object, or null if no match is found.
   * 
   */
  public TestR2aMatch getOneArbitraryMatch(final AgentInstance pA, final String pAgentName, final String pSiteName) {
   ...
   * 
   */
  public void forEachMatch(final AgentInstance pA, final String pAgentName, final String pSiteName, final IMatchProcessor<? super TestR2aMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final AgentInstance pA, final String pAgentName, final String pSiteName, final IMatchProcessor<? super TestR2aMatch> processor) {
   ...
   * 
   */
  public TestR2aMatch newMatch(final AgentInstance pA, final String pAgentName, final String pSiteName) {
    return TestR2aMatch.newMatch(pA, pAgentName, pSiteName);
  }
   ...
   * 
   */
  public Set<AgentInstance> getAllValuesOfa(final TestR2aMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOfagentName(final TestR2aMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOfsiteName(final TestR2aMatch partialMatch) {
  ...
  @Override
  protected TestR2aMatch tupleToMatch(final Tuple t) {
    try {
        return TestR2aMatch.newMatch((AgentInstance) t.get(POSITION_A), (String) t.get(POSITION_AGENTNAME), (String) t.get(POSITION_SITENAME));
  ...
  @Override
  protected TestR2aMatch arrayToMatch(final Object[] match) {
    try {
        return TestR2aMatch.newMatch((AgentInstance) match[POSITION_A], (String) match[POSITION_AGENTNAME], (String) match[POSITION_SITENAME]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected TestR2aMatch arrayToMatchMutable(final Object[] match) {
    try {
        return TestR2aMatch.newMutableMatch((AgentInstance) match[POSITION_A], (String) match[POSITION_AGENTNAME], (String) match[POSITION_SITENAME]);
    } catch(ClassCastException e) {
        LOGGER.error("Element(s) in array not properly typed!",e);
        return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<TestR2aMatcher> querySpecification() throws ViatraQueryException {
