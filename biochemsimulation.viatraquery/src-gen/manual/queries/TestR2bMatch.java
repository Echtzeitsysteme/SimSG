...
/**
 * Pattern-specific match representation of the manual.queries.testR2b pattern,
 * to be used in conjunction with {@link TestR2bMatcher}.
 * 
...
public abstract class TestR2bMatch extends BasePatternMatch {
  ...
  private TestR2bMatch(final AgentInstance pA, final AgentInstance pB) {
    this.fA = pA;
    this.fB = pB;
  }
  ...
  public List<String> parameterNames() {
    return TestR2bMatch.parameterNames;
  }
  ...
  @Override
  public TestR2bMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof TestR2bMatch)) {
        TestR2bMatch other = (TestR2bMatch) obj;
  ...
  @Override
  public TestR2bQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TestR2bMatch newEmptyMatch() {
   ...
   * 
   */
  public static TestR2bMatch newMutableMatch(final AgentInstance pA, final AgentInstance pB) {
   ...
   * 
   */
  public static TestR2bMatch newMatch(final AgentInstance pA, final AgentInstance pB) {
    return new Immutable(pA, pB);
  }
  
  private static final class Mutable extends TestR2bMatch {
  ...
  private static final class Immutable extends TestR2bMatch {
