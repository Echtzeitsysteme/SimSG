...
/**
 * A pattern-specific query specification that can instantiate TestR2aMatcher in a type-safe way.
 * 
 * @see TestR2aMatcher
 * @see TestR2aMatch
 * 
...
public final class TestR2aQuerySpecification extends BaseGeneratedEMFQuerySpecification<TestR2aMatcher> {
  private TestR2aQuerySpecification() {
   ...
   * 
   */
  public static TestR2aQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TestR2aMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TestR2aMatcher.on(engine);
  }
  
  @Override
  public TestR2aMatcher instantiate() throws ViatraQueryException {
    return TestR2aMatcher.create();
  }
  
  @Override
  public TestR2aMatch newEmptyMatch() {
    return TestR2aMatch.newEmptyMatch();
  }
  
  @Override
  public TestR2aMatch newMatch(final Object... parameters) {
    return TestR2aMatch.newMatch((biochemsimulation.reactionrules.reactionRules.AgentInstance) parameters[0], (java.lang.String) parameters[1], (java.lang.String) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: manual.queries.util.TestR2aQuerySpecification (visibility: PUBLIC, simpleName: TestR2aQuerySpecification, identifier: manual.queries.util.TestR2aQuerySpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: manual.queries.util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class LazyHolder {
    private final static TestR2aQuerySpecification INSTANCE = new TestR2aQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TestR2aQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      Set<PBody> bodies = Sets.newLinkedHashSet();
      {
          ...
          // 	IndexedLink(als)
          new TypeConstraint(body, Tuples.flatTupleOf(var_als), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.reactionrules.biochemsimulation/ReactionRules", "IndexedLink")));
          bodies.add(body);
      }
      return bodies;
    }
