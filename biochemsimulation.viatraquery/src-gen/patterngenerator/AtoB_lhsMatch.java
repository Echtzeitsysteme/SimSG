...
public abstract class AtoB_lhsMatch extends BasePatternMatch {
  ...
  private AtoB_lhsMatch(final AgentInstance pA, final AgentInstance pB) {
    this.fA = pA;
    this.fB = pB;
  }
   ...
   * 
   */
  public static AtoB_lhsMatch newMutableMatch(final AgentInstance pA, final AgentInstance pB) {
   ...
   * 
   */
  public static AtoB_lhsMatch newMatch(final AgentInstance pA, final AgentInstance pB) {
