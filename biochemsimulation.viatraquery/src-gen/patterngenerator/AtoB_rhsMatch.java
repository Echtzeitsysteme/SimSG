...
public abstract class AtoB_rhsMatch extends BasePatternMatch {
  ...
  private LimitLink fA_x_ILS_state;
  ...
  private LimitLink fB_x_ILS_state;
  ...
  public LimitLink getA_x_ILS_state() {
  ...
  public LimitLink getB_x_ILS_state() {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("A_x_ILS_state".equals(parameterName) ) {
        this.fA_x_ILS_state = (LimitLink) newValue;
        return true;
    }
    ...
    if ("B_x_ILS_state".equals(parameterName) ) {
        this.fB_x_ILS_state = (LimitLink) newValue;
        return true;
    }
    return false;
  }
  ...
  public void setA_x_ILS_state(final LimitLink pA_x_ILS_state) {
    if (!isMutable()) throw new java.lang.UnsupportedOperationException();
    this.fA_x_ILS_state = pA_x_ILS_state;
  }
  ...
  public void setB_x_ILS_state(final LimitLink pB_x_ILS_state) {
    if (!isMutable()) throw new java.lang.UnsupportedOperationException();
    this.fB_x_ILS_state = pB_x_ILS_state;
  }
   ...
   * 
   */
  public static AtoB_rhsMatch newMutableMatch(final AgentInstance pA, final String pAgent_A_Name, final AgentInstanceLinkState pA_xILS, final String pA_x_ILS_name, final LimitLink pA_x_ILS_state, final AgentInstance pB, final String pAgent_B_Name, final AgentInstanceLinkState pB_xILS, final String pB_x_ILS_name, final LimitLink pB_x_ILS_state) {
   ...
   * 
   */
  public static AtoB_rhsMatch newMatch(final AgentInstance pA, final String pAgent_A_Name, final AgentInstanceLinkState pA_xILS, final String pA_x_ILS_name, final LimitLink pA_x_ILS_state, final AgentInstance pB, final String pAgent_B_Name, final AgentInstanceLinkState pB_xILS, final String pB_x_ILS_name, final LimitLink pB_x_ILS_state) {
  ...
  private static final class Mutable extends AtoB_rhsMatch {
    Mutable(final AgentInstance pA, final String pAgent_A_Name, final AgentInstanceLinkState pA_xILS, final String pA_x_ILS_name, final LimitLink pA_x_ILS_state, final AgentInstance pB, final String pAgent_B_Name, final AgentInstanceLinkState pB_xILS, final String pB_x_ILS_name, final LimitLink pB_x_ILS_state) {
  ...
  private static final class Immutable extends AtoB_rhsMatch {
    Immutable(final AgentInstance pA, final String pAgent_A_Name, final AgentInstanceLinkState pA_xILS, final String pA_x_ILS_name, final LimitLink pA_x_ILS_state, final AgentInstance pB, final String pAgent_B_Name, final AgentInstanceLinkState pB_xILS, final String pB_x_ILS_name, final LimitLink pB_x_ILS_state) {
      super(pA, pAgent_A_Name, pA_xILS, pA_x_ILS_name, pA_x_ILS_state, pB, pAgent_B_Name, pB_xILS, pB_x_ILS_name, pB_x_ILS_state);
    }
