...
public abstract class CtoNull2_lhsMatch extends BasePatternMatch {
  ...
  private CtoNull2_lhsMatch(final AgentInstance pC) {
    this.fC = pC;
  }
   ...
   * 
   */
  public static CtoNull2_lhsMatch newMutableMatch(final AgentInstance pC) {
   ...
   * 
   */
  public static CtoNull2_lhsMatch newMatch(final AgentInstance pC) {
