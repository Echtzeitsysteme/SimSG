...
/**
 * Pattern-specific match representation of the patterngenerator.CtoNull_lhs pattern,
 * to be used in conjunction with {@link CtoNull_lhsMatcher}.
 * 
...
public abstract class CtoNull_lhsMatch extends BasePatternMatch {
  ...
  public List<String> parameterNames() {
    return CtoNull_lhsMatch.parameterNames;
  }
  ...
  @Override
  public CtoNull_lhsMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    ...
    if ((obj instanceof CtoNull_lhsMatch)) {
        CtoNull_lhsMatch other = (CtoNull_lhsMatch) obj;
  ...
  @Override
  public CtoNull_lhsQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CtoNull_lhsMatch newEmptyMatch() {
