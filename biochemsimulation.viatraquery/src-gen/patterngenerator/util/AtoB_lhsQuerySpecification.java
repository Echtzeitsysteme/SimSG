...
public final class AtoB_lhsQuerySpecification extends BaseGeneratedEMFQuerySpecification<AtoB_lhsMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_pA_x_ILS_state = new PParameter("A_x_ILS_state", "biochemsimulation.reactionrules.reactionRules.FreeLink", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.reactionrules.biochemsimulation/ReactionRules", "FreeLink")), PParameterDirection.INOUT);
    ...
    private final PParameter parameter_pB_x_ILS_state = new PParameter("B_x_ILS_state", "biochemsimulation.reactionrules.reactionRules.FreeLink", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.reactionrules.biochemsimulation/ReactionRules", "FreeLink")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      Set<PBody> bodies = Sets.newLinkedHashSet();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_A_x_ILS_state), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.reactionrules.biochemsimulation/ReactionRules", "FreeLink")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_B_x_ILS_state), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.reactionrules.biochemsimulation/ReactionRules", "FreeLink")));
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern AtoB_lhs";
              }
