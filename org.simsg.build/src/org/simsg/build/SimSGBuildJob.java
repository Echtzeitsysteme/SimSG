...
public class SimSGBuildJob extends WorkspaceJob {
	private static final String JOB_NAME = "SimSG Manual Build";

	private static final Logger logger = Logger.getLogger(SimSGBuildJob.class);
	 ...
	 */
	public SimSGBuildJob(final List<IProject> projects, int buildType) {
		super(JOB_NAME);
