...
public class ContainerFactoryImpl extends EFactoryImpl implements ContainerFactory {
	...
	public static ContainerFactory init() {
		try {
			ContainerFactory theContainerFactory = (ContainerFactory) EPackage.Registry.INSTANCE
					.getEFactory(ContainerPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case ContainerPackage.STATE:
			return createState();
		case ContainerPackage.AGENT:
			return createAgent();
		default:
	 ...
	 * @generated
	 */
	public org.simsg.container.Container createContainer() {
