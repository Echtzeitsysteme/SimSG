/**
 */
package org.simsg.container.impl;
...
public class ContainerPackageImpl extends EPackageImpl implements ContainerPackage {
	 ...
	 * @see org.simsg.container.ContainerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ContainerPackage init() {
		if (isInited)
			return (ContainerPackage) EPackage.Registry.INSTANCE.getEPackage(ContainerPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredContainerPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ContainerPackageImpl theContainerPackage = registeredContainerPackage instanceof ContainerPackageImpl
				? (ContainerPackageImpl) registeredContainerPackage
				: new ContainerPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(containerEClass, org.simsg.container.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Agents(), this.getAgent(), null, "agents", null, 0, -1,
				org.simsg.container.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContainer_ModelName(), theXMLTypePackage.getString(), "ModelName", null, 0, 1,
				org.simsg.container.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
