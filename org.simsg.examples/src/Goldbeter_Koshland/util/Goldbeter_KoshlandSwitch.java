 ...
 * @generated
 */
public class Goldbeter_KoshlandSwitch<T1> extends Switch<T1> {
	/**
	 ...
	 * @generated
	 */
	public Goldbeter_KoshlandSwitch() {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Goldbeter_KoshlandPackage.K: {
				K k = (K)theEObject;
				T1 result = caseK(k);
			...
			case Goldbeter_KoshlandPackage.P: {
				P p = (P)theEObject;
				T1 result = caseP(p);
			...
			case Goldbeter_KoshlandPackage.T: {
				T t = (T)theEObject;
				T1 result = caseT(t);
			...
			case Goldbeter_KoshlandPackage.US: {
				us us = (us)theEObject;
				T1 result = caseus(us);
				if (result == null) result = caseState(us);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Goldbeter_KoshlandPackage.PS: {
				ps ps = (ps)theEObject;
				T1 result = caseps(ps);
				if (result == null) result = caseState(ps);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
