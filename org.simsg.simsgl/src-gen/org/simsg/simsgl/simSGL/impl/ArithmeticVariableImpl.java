 ...
 * </p>
 * <ul>
 *   <li>{@link org.simsg.simsgl.simSGL.impl.ArithmeticVariableImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArithmeticVariableImpl extends VariableImpl implements ArithmeticVariable
{
  ...
  {
    return SimSGLPackage.Literals.ARITHMETIC_VARIABLE;
  }
  ...
  public NotificationChain basicSetValue(ArithmeticValue newValue, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimSGLPackage.ARITHMETIC_VARIABLE__VALUE, oldValue, newValue);
  ...
  public void setValue(ArithmeticValue newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimSGLPackage.ARITHMETIC_VARIABLE__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimSGLPackage.ARITHMETIC_VARIABLE__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimSGLPackage.ARITHMETIC_VARIABLE__VALUE, newValue, newValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SimSGLPackage.ARITHMETIC_VARIABLE__VALUE:
