 ...
 * </p>
 * <ul>
 *   <li>{@link org.simsg.simsgl.simSGL.impl.AssignFromVariableImpl#getPatternVar <em>Pattern Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssignFromVariableImpl extends PatternAssignmentImpl implements AssignFromVariable
{
  ...
  {
    return SimSGLPackage.Literals.ASSIGN_FROM_VARIABLE;
  }
    ...
    if (patternVar != null && patternVar.eIsProxy())
    {
      ...
      if (patternVar != oldPatternVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimSGLPackage.ASSIGN_FROM_VARIABLE__PATTERN_VAR, oldPatternVar, patternVar));
      }
    }
    return patternVar;
  }
  ...
  public void setPatternVar(PatternVariable newPatternVar)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimSGLPackage.ASSIGN_FROM_VARIABLE__PATTERN_VAR, oldPatternVar, patternVar));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SimSGLPackage.ASSIGN_FROM_VARIABLE__PATTERN_VAR:
