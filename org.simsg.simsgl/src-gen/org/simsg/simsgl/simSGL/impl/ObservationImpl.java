 ...
 * </p>
 * <ul>
 *   <li>{@link org.simsg.simsgl.simSGL.impl.ObservationImpl#getObservationPattern <em>Observation Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObservationImpl extends SimSGLPropertyImpl implements Observation
{
  /**
  ...
  {
    return SimSGLPackage.Literals.OBSERVATION;
  }
  ...
  public NotificationChain basicSetObservationPattern(PatternAssignment newObservationPattern, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimSGLPackage.OBSERVATION__OBSERVATION_PATTERN, oldObservationPattern, newObservationPattern);
  ...
  public void setObservationPattern(PatternAssignment newObservationPattern)
  {
    if (newObservationPattern != observationPattern)
    {
      ...
      if (observationPattern != null)
        msgs = ((InternalEObject)observationPattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimSGLPackage.OBSERVATION__OBSERVATION_PATTERN, null, msgs);
      if (newObservationPattern != null)
        msgs = ((InternalEObject)newObservationPattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimSGLPackage.OBSERVATION__OBSERVATION_PATTERN, null, msgs);
      msgs = basicSetObservationPattern(newObservationPattern, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimSGLPackage.OBSERVATION__OBSERVATION_PATTERN, newObservationPattern, newObservationPattern));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SimSGLPackage.OBSERVATION__OBSERVATION_PATTERN:
