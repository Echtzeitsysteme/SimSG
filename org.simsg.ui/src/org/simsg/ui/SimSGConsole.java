...
public class SimSGConsole extends WriterAppender {

	private static final String SIMSG_CONSOLE = "SimSG";
	private static final String PATTERN_KEY = "log4j.appender." + SIMSG_CONSOLE + ".layout.ConversionPattern";
	...
	private static final Color GREEN = new Color(Display.getDefault(), 44, 141, 20);

	private static final Color YELLOW = new Color(Display.getDefault(), 239, 155, 15);

	public SimSGConsole(final URL configFile) {
	...
	/**
	 * Prints a message on the SimSGConsole.
	 * 
	 * @param message
	...
	/**
	 * Prints a message in red on the SimSGConsole.
	 * 
	 * @param message
	 *            The message to print.
	 */
	...
	/**
	 * Prints a message in blue on the SimSGConsole.
	 * 
	 * @param message
	 *            The message to print.
	 */
	...
	private static void _printMessage(final String message, final Color color) {
		MessageConsole myConsole = findConsole(SIMSG_CONSOLE);
	...
	/**
	 * Gets the output stream of the SimSGConsole.
	 * 
	 * @return
	 */
